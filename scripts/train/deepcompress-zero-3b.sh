...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    actor_rollout_ref.model.path=skytliang/Qwen2.5-3B-orz \
    ...
    custom_reward_function.length_reward.enable=True \
    custom_reward_function.length_reward.weight=0.2 \
    custom_reward_function.length_reward.only_correct=True \
    custom_reward_function.length_reward.moving_average.weight=0.99 \
